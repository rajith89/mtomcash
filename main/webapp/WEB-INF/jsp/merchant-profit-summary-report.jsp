...
<script>
	...
	function onSearch() {
		...
		$.ajax({
			//url : "/bo/bo/merchanttransaction/merchantprofitsummarylist.json-"+ dateFrom + "-" + dateTo + "-" + type,
			url : "merchantprofitsummarylist.json-"+ dateFrom + "-" + dateTo + "-" + type,
			...
			success : function(data) {
				...
				$.each(data, function(index, val) {
					...
					row += "<td>" + val.profit +  " " + val.currency +"</td>";

					$("#transactionGrid tr:last").after(row);
					totalAmount += val.profit;
