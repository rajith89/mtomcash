...
<script>
	...
	function onSearch() {
		...
		$.ajax({
			//url : "/bo/bo/merchanttransaction/merchanttransactionlist.json-"+ dateFrom + "-" + dateTo + "-" + merchant,
			url : "merchanttransactionlist.json-"+ dateFrom + "-" + dateTo + "-" + merchant,
